    ...
    return (
        <main className="mainSiteParent">
            ...
            <div className="mainSiteChild">
                ...
                <h3 id="goalsSubTitle">My ambition is to become employed as a full-time Web-Developer.</h3>
                    <p className="mainP">
                    ...
                    <aside>
                        I am currently doing a <strong>Front End Development Course</strong> through <strong>EDX</strong> to further upskill in React.js and associated technologies.
                    </aside>
                ...
                <p>
                    ...
                    course specialising in JavaScript/React/CSS. This was co-certified by the University of Manchester in partnership with the Department for Education 
                ...
                <ul>
                    <li className="mainULEdu">Front-End Development Course. EDX (Remote) 2023 - Current.</li>
